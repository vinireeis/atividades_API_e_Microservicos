...
def atividade_por_id(id_atividade):
    ...
    for atividade in atividades:
        if atividade['id_atividade'] == id_atividade:
            ...
            if id_prof is False or not a.leciona(id_prof,
               copy_atividade['id_disciplina']):
                del copy_atividade['respostas']
            return {'isok': True, 'atividade': copy_atividade,
                    "id_professor": id_prof}
    return {'isok': False, 'erro': 'atividade nao encontrada',
            "id_professor": id_prof}, 404
